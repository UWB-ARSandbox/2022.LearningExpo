...
public class AssessmentManager : MonoBehaviour {
    ...
    public question[] assessmentQuestions;
    ...
    public int num_TotalQuestions = -1;
    public int num_CorrectAnswers = -1;
    public float testTimeLimit = -1;
    public float testTimeRemaining = -1;
    public float questionTimeLimit = -1;
    public float questionTimeRemaining = -1;
    public bool lockedOut = false;
    public bool questionTimerActive = false;
    public bool lockoutTimerActive = false;
    ...
    public GameObject pnl_Response;
    ...
    //Multiple Choice
    public GameObject pnl_MultipleChoice;
    public TextMeshProUGUI txt_MultChoiceQuestion;
    public Image[] imgAry_multipleChoice = new Image[4];
    public TextMeshProUGUI[] txtAry_mcOptionLetters = new TextMeshProUGUI[4];
    public TextMeshProUGUI[] txtAry_mcOptionText = new TextMeshProUGUI[4];
    public Button[] btnAry_multipleChoice = new Button[4];
    ...
    //True/False
    public GameObject pnl_TrueFalse;
    public TextMeshProUGUI txt_TrueFalseQuestion;
    public Image img_True;
    public Image img_False;
    public TextMeshProUGUI txt_True;
    public TextMeshProUGUI txt_False;
    public Button btn_True;
    public Button btn_False;

    //Short Answer
    public GameObject pnl_ShortAnswer;
    public TextMeshProUGUI txt_ShortAnswerQuestion;
    public TextMeshProUGUI txt_ShortAnswerResponse;
    public TextMeshProUGUI txt_ShortAnswerCorrect;
    public string resetResponseText;
    public InputField ipt_Answer;
    public Button btn_Submit;

    //End Screen
    public GameObject pnl_EndScreen;
    public TextMeshProUGUI txt_EndTitle;
    public TextMeshProUGUI txt_EndDesc;

    //Dashboard
    public GameObject pnl_Dashboard;
    public GameObject pnl_Progress;
    public TextMeshProUGUI lbl_Question;
    public TextMeshProUGUI txt_QuestionNumber;
    public GameObject pnl_CurrentScore;
    public TextMeshProUGUI lbl_CurrentScore;
    public TextMeshProUGUI txt_CurrentScore;
    public GameObject pnl_QuestionValue;
    public TextMeshProUGUI lbl_QuestionValue;
    public TextMeshProUGUI txt_QuestionValue;
    public GameObject pnl_CurrentPoints;
    public TextMeshProUGUI lbl_CurrentPoints;
    public TextMeshProUGUI txt_CurrentPoints;
    public GameObject pnl_TimeLeft;
    public TextMeshProUGUI lbl_TimeLeft;
    public TextMeshProUGUI txt_TimeLeft;
    public GameObject pnl_QuestionTimer;
    public Image img_QuestionTimer;
    public float QUESTION_TIMER_INTIAL_WIDTH;
    public TextMeshProUGUI lbl_QuestionTimer;
    public TextMeshProUGUI txt_QuestionTimer;
    ...
    private void CheckMCResponse(int response) {
        //If response is out of range, ignore.
        if (response > currentQuestion.answers.Answer.Length) {
            return;
        }
